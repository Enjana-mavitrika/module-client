...
var ClientService = /** @class */ (function () {
    ...
    ClientService.getClient = function (id) {
        return fetch(this.urlGetClientAPI + "/" + id).then(function (response) { return response.json(); });
    };
    ClientService.putClient = function () {
    ...
    ClientService.urlGetClientAPI = "/api/Client";
    ClientService.urlPutClientAPI = "/api/Client";
